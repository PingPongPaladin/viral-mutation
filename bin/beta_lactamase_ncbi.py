...
def parse_args():
    ...
    parser.add_argument('--namespace', type=str, default='beta_lactamase_ncbi',
...
def setup(args):
    ncbi_fname = "/afs/csail.mit.edu/u/a/andytso/meng/data/ncbi_capped_downsampled_beta_lactamase.fasta"
    fnames = [ncbi_fname]
    meta_fnames = [ncbi_fname]
...
if __name__ == '__main__':
    ...
    if args.semantics:
        ...
        seq_to_mutate, escape_seqs = load_russ2020(escape_criteria="escape")
        min_pos = 0
