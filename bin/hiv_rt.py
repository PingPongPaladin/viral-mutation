...
def parse_args():
    ...
    parser.add_argument('--namespace', type=str, default='hiv_rt',
...
def setup(args):
    lanl_fname = "/afs/csail.mit.edu/u/a/andytso/meng/data/HIV-1_rt.fasta"
    stanford_fname = "/afs/csail.mit.edu/u/a/andytso/meng/data/stanford_rt.fasta"
